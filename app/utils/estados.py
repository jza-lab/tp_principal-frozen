...
OV_LISTA_PARA_ARMAR = 'LISTO_PARA_ARMAR' # Corregido de LISTA_PARA_ARMAR
OV_ITEM_ALISTADO = 'ITEM_ALISTADO'
OV_LISTA_PARA_ENTREGAR = 'LISTA_PARA_ENTREGAR'
...
OV_MAP_STRING_TO_INT = {
    ...
    OV_PLANIFICADA: 20,
    OV_EN_PROCESO: 30,
    OV_LISTA_PARA_ARMAR: 40,
    OV_LISTA_PARA_ENTREGAR: 50,
    OV_EN_TRANSITO: 60,
    OV_DESPACHADO: 70,
    OV_ENTREGADO: 80,
    OV_RECEPCION_OK: 90,
...
OV_FILTROS_UI = [
    ...
    (OV_LISTA_PARA_ENTREGAR, 'Lista Para Entregar'),
    ...
    (OV_RECHAZADA, 'Rechazada'),
    (OV_CANCELADA, 'Cancelada'),
    (OV_ITEM_ALISTADO, 'Item Alistado'),
    (OV_LISTA_PARA_ARMAR, 'Listo Para Armar')
]
...
OC_MAP_STRING_TO_INT = {
    ...
    OC_EN_TRANSITO: 40,
    OC_RECIBIDA: 50, # Estado intermedio antes de OK/Incompleta
    OC_RECEPCION_OK: 60,
    OC_RECEPCION_INCOMPLETA: 70,
