...
@admin_permission_required(accion='gestionar_proveedores') # Asumido
def listar_clientes():
...
@admin_permission_any_of('gestionar_proveedores', 'inactivar_proveedores_clientes') # Asumido para gestionar
