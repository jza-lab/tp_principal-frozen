...
@permission_required(sectores=['CALIDAD'], accion='realizar_control_calidad')
def listar_lotes():
...
@permission_required(sectores=['CALIDAD'], accion='control_calidad_lote')
def nuevo_lote():
...
@permission_required(sectores=['CALIDAD'], accion='ver_historial_controles')
def obtener_lotes():
...
@permission_required(sectores=['CALIDAD'], accion='rechazar_lotes')
...
@permission_required(sectores=['CALIDAD'], accion='aprobar_lotes')
