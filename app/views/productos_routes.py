...
@permission_any_of('produccion_gestion_completa', 'almacen_gestion_completa')
def crear_producto():
    try:
...
@permission_any_of('produccion_gestion_completa', 'almacen_gestion_completa', 'produccion_consulta', 'almacen_consulta_stock')
