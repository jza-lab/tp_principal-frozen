...
def indicadores():
    """
    Renderiza la página principal del dashboard de indicadores.
    La carga de datos se maneja de forma asíncrona por el frontend (JavaScript).
    """
    return render_template('indicadores/dashboard.html', datetime=datetime, timedelta=timedelta)
